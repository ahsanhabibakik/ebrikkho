      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Ebrikkho</h3>
            <p className="text-gray-600 mb-4">
              A modern web application built with Next.js and TypeScript, 
              designed to provide exceptional user experiences.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-600">
            © {currentYear} Ebrikkho. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
