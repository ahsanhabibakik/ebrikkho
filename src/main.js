...
function updateCountdown() {
  ...
  const countdownElements = countdownContainer.querySelectorAll(
    'span[style*="--value"]'
  );
  ...
  function updateTimer() {
    ...
    countdownElements[0].setAttribute(
      "aria-label",
    ...
    countdownElements[1].setAttribute(
      "aria-label",
    ...
    countdownElements[2].setAttribute(
      "aria-label",
    ...
    countdownElements[3].setAttribute(
      "aria-label",
